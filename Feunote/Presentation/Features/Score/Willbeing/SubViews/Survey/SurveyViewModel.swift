...
final class SurveyViewModel : ObservableObject, Codable {
    ...
    init(_ questions : [SurveyQuestion], version : String, title:String, description:String) {
...
extension SurveyQuestion {
    ...
    func isVisible( for survey: SurveyViewModel ) -> Bool {
