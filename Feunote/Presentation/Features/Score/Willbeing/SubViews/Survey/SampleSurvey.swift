...
let SampleSurvey = SurveyViewModel([
...
version: "001", title: "Big Five Personality", description: "The Big Five personality traits are extraversion (also often spelled extroversion), agreeableness, openness, conscientiousness, and neuroticism.")
