...
//                .frame(width:300,height:40)
                ...
                Button {
                    ...
                    .frame(width: 300, height: 40)
                    .background(Color(hexString: "EEEEEE"), in: RoundedRectangle(cornerRadius: 8))
                }
...
struct SignInView_Previews: PreviewProvider {
    private static var authvm: AuthViewModel = .init(signInUseCase: FakeSignInUseCase(), signUpUseCase: SignUpUseCase(), confirmSignUpUseCase: ConfirmSignUpUseCase(), signOutUserCase: SignOutUseCase(), socialSignInUseCase: SocialSignInUseCase())
