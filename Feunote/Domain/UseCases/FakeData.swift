...
let fakeAmplifyMoment2 = AmplifyCommit(id: "M2", owner: "s524256521", commitType: .moment, titleOrName: "金融推荐书", description: "When Genius Failed(营救华尔街）\n Too big to fail (大而不倒) \n The essavs of Warren Buffett (巴菲特致股东的信）\n Freakonomics (魔鬼经济学）\n Principles (原则)", photoKeys: ["demo-picture-1", nil, "demo-picture-2", "demo-picture-3", "demo-picture-4"], audioKeys: ["audio-1"], videoKeys: ["video-1"], toBranch: fakeAmplifyBranchOpen1, momentWordCount: 21, todoCompletion: nil, todoReminder: nil, todoStart: nil, todoEnd: nil, personPriority: nil, personAddress: nil, personBirthday: nil, personContact: nil, personAvatarKey: nil, createdAt: Temporal.DateTime.now(), updatedAt: Temporal.DateTime.now())

let fakeAmplifyTodo1 = AmplifyCommit(id: "T1", owner: "s524256521", commitType: .todo, titleOrName: "Organize yourwork and life, finally.", description: "Become focused, organized, and calm with Todoist. The world’s #1 task manager and to-do list app.", photoKeys: nil, audioKeys: nil, videoKeys: nil, toBranch: fakeAmplifyBranchOpen1, momentWordCount: nil, todoCompletion: false, todoReminder: true, todoStart: Temporal.DateTime.now(), todoEnd: Temporal.DateTime.now(), personPriority: nil, personAddress: nil, personBirthday: nil, personContact: nil, personAvatarKey: nil, createdAt: Temporal.DateTime.now(), updatedAt: Temporal.DateTime.now())

let fakeAmplifyTodo2 = AmplifyCommit(id: "T2", owner: "s524256521", commitType: .todo, titleOrName: "写文：幸福指数与GDP", description: "", photoKeys:nil, audioKeys: nil, videoKeys:nil, toBranch: fakeAmplifyBranchOpen1, momentWordCount: nil, todoCompletion: false, todoReminder: true, todoStart: Temporal.DateTime.now(), todoEnd: Temporal.DateTime.now(), personPriority: nil, personAddress: nil, personBirthday: nil, personContact: nil, personAvatarKey: nil, createdAt: Temporal.DateTime.now(), updatedAt: Temporal.DateTime.now())

let fakeAmplifyPerson1 = AmplifyCommit(id: "P1", owner: "s524256521", commitType: .person, titleOrName: "Martin Elias Peter Seligman", description: "an American psychologist, educator, and author of self-help books. Seligman is a strong promoter within the scientific community of his theories of positive psychology[1] and of well-being. His theory of learned helplessness is popular among scientific and clinical psychologists.[2] A Review of General Psychology survey, published in 2002, ranked Seligman as the 31st most cited psychologist of the 20th century.[3]", photoKeys: [], audioKeys: [], videoKeys: [], toBranch: fakeAmplifyBranchOpen1, momentWordCount: nil, todoCompletion: nil, todoReminder: nil, todoStart: nil, todoEnd: nil, personPriority: 9, personAddress: "711-2880 Nulla St., Mankato Mississippi, 96522", personBirthday: Temporal.Date(Date.distantPast.addingTimeInterval(10000)), personContact: "(257) 563-7401", personAvatarKey: "demo-person-1", createdAt: Temporal.DateTime.now(), updatedAt: Temporal.DateTime.now())

let fakeAmplifyPerson2 = AmplifyCommit(id: "P2", owner: "s524256521", commitType: .person, titleOrName: "Andrew Yan-Tak Ng", description: "a British-born American computer scientist and technology entrepreneur focusing on machine learning and AI.[2] Ng was a co-founder and head of Google Brain and was the former chief scientist at Baidu, building the company's Artificial Intelligence Group into a team of several thousand people.[3]", photoKeys: [], audioKeys: nil, videoKeys: nil, toBranch:fakeAmplifyBranchOpen1, momentWordCount: nil, todoCompletion: nil, todoReminder: nil, todoStart: nil, todoEnd: nil, personPriority: 9, personAddress: "", personBirthday: Temporal.Date(Date.distantPast.addingTimeInterval(1000)), personContact: "(257) 523-7421", personAvatarKey: "demo-person-2", createdAt: Temporal.DateTime.now(), updatedAt: Temporal.DateTime.now())



let fakeAmplifyBranchOpen1 = AmplifyBranch(id: "BO1", owner: "s524256521", privacyType: .open, title: "Smart Ring for the Blind", description: "We plan to create a smart ring for people thant cannot see. It support text input, voice recording and mobile payment.", squadName: "Goldeb Fish", commits:[],actions:[], numOfLikes: 135233, numOfDislikes: 123123, numOfComments: 123123, numOfShares: 1231, numOfSubs: 4242, createdAt: Temporal.DateTime.now(), updatedAt: Temporal.DateTime.now())
